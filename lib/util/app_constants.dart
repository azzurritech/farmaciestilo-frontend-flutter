...
import 'package:farmacie_stilo/data/model/response/choose_us_model.dart';
import 'package:farmacie_stilo/data/model/response/language_model.dart';
import 'package:farmacie_stilo/util/images.dart';
class AppConstants {
  static const String appName = 'FarmacieStilo';
  static const double appVersion = 0.1;
  static const String baseUrl = "https://new-admin.farmaciestilo.com";
  static String BASE_URL_NEW = "https://new-admin.farmaciestilo.com/api/v3/";
  //  static String BASE_URL_NEW = "https://stilo.doclive.info/api/";
  ...
  // Shared Key
  static const String theme = 'FarmacieStilo_theme';
  static const String token = 'FarmacieStilo_token';
  static const String countryCode = 'FarmacieStilo_country_code';
  static const String languageCode = 'FarmacieStilo_language_code';
  static const String cartList = 'FarmacieStilo_cart_list';
  static const String userPassword = 'FarmacieStilo_user_password';
  static const String userAddress = 'FarmacieStilo_user_address';
  static const String userNumber = 'FarmacieStilo_user_number';
  static const String userCountryCode = 'FarmacieStilo_user_country_code';
  static const String notification = 'FarmacieStilo_notification';
  static const String searchHistory = 'FarmacieStilo_search_history';
  static const String intro = 'FarmacieStilo_intro';
  static const String id = 'user_id';
  static const String notificationCount = 'FarmacieStilo_notification_count';
  ...
  static List<ChooseUsModel> whyChooseUsList = [
    ...
    static List<ChooseUsModelIt> whyChooseUsListIt = [
   ChooseUsModelIt(
        icon: Images.landingTrustedit,
        title: 'trusted_by_customers_and_store_owners'),
   ChooseUsModelIt(icon: Images.landingStoresit, title: 'thousands_of_stores'),
   ChooseUsModelIt(
        icon: Images.landingExcellentit, title: 'excellent_shopping_experience'),
    ChooseUsModelIt(
        icon: Images.landingCheckoutit,
        title: 'easy_checkout_and_payment_system'),
        //   ChooseUsModel(
        // icon: Images.videocall,
        // title: 'video_call'),
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(
        ...
        countryCode: 'IT', // Corrected country code for Italy
        languageCode: 'it'), // 'it' is the
        //    LanguageModel(
        // imageUrl: Images.imageenglish,

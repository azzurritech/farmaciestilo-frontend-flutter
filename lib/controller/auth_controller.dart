...
import 'package:farmacie_stilo/data/model/body/delivery_man_body.dart';
import 'package:farmacie_stilo/data/model/body/store_body.dart';
import 'package:farmacie_stilo/data/model/body/signup_body.dart';
import 'package:farmacie_stilo/data/model/body/social_log_in_body.dart';
import 'package:farmacie_stilo/data/model/response/delivery_man_vehicles.dart';
...
import 'package:farmacie_stilo/data/model/response/zone_model.dart';
...
bool get termsnew=> _termsnew;
  ...
  Future<SizedBox> savessession() async {
    var data=await http.get(Uri.parse("https://new-admin.farmaciestilo.com/api/v3/data"),);
     ResponseModel responsesModel;
    if(data.statusCode==200){
      print(data.body.toString());
    }else {
      responsesModel = ResponseModel(false, data.body);
    }
     return  SizedBox();
  }

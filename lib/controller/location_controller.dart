...
import 'package:farmacie_stilo/data/model/response/place_details_model.dart';
import 'package:farmacie_stilo/data/model/response/prediction_model.dart';
...
import 'package:farmacie_stilo/view/screens/location/widget/module_dialog.dart';
import 'package:farmacie_stilo/view/screens/location/widget/permission_dialog.dart';
...
class LocationController extends GetxController implements GetxService {
  ...
  final List<String?> _addressTypeList = ["Address"];
  ...
  void setUpdateAddress(AddressModel address) {
    _position = Position(
      ...
      speedAccuracy: 1,
      floor: 1,
      accuracy: 1, headingAccuracy: 0, altitudeAccuracy: 0,
    );

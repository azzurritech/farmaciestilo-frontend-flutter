...
import 'package:farmacie_stilo/view/screens/checkout/widget/payment_failed_dialog.dart';
 int? state=0;
class PaymentScreen extends StatefulWidget {
  ...
  PaymentScreen(
      {Key? key,required this.orderModel, required this.isCashOnDelivery})
      : super(key: key);
...
class PaymentScreenState extends State<PaymentScreen> {
  ...
  void _initData() async {
    ...
    //     crossPlatform:
    //         InAppBrowserOptions(hideUrlBar: false, hideToolbarTop: false),
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body:  state == 0 ? SizedBox() :  PaymentFailedDialog(
          orderID: widget.orderModel.id.toString(),
          orderAmount: widget.orderModel.orderAmount,
          maxCodOrderAmount: _maximumCodOrderAmount,
          orderType: widget.orderModel.orderType,

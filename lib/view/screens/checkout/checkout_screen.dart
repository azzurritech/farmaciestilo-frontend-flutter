                    ...
                    return (orderController.distance != null &&
                        ...
                        Container(   padding: const EdgeInsets
                          ...
                          child: Column(
                            children: [
                              Row(children: [
                                Text("code".tr  ,style:  robotoMedium),
                              Checkbox(
    ...
    if (isSuccess) {
      ...
      if (Get.find<OrderController>().paymentMethodIndex == 0) {
        if (GetPlatform.isWeb) {
          ...
          String selectedUrl =
              '${AppConstants.baseUrl}/payment-mobile?order_id=$orderID&&customer_id=${Get.find<UserController>().userInfoModel!.id}&&lang=${Get.find<LocalizationController>().locale!.languageCode}&&callback=$protocol//$hostname${RouteHelper.orderSuccess}?id=$orderID&status=';
...
// }).toList());
String paymentUrl = '${AppConstants.baseUrl}/payment-mobile?customer_id=${int.parse(Get.parameters['user']!)}&&lang=${Get.find<LocalizationController>().locale!.languageCode}&order_id=${int.parse(Get.parameters['id']!)}';

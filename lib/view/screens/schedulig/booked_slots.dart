    ...
    return Scaffold(
        ...
        body: ref.watch(sheduleCallProvider).load == true
            ...
            : Column(
                ...
                decoration: BoxDecoration(image: DecorationImage(image: AssetImage(Images.lanbanner3), fit: BoxFit.cover)),
                ):   Container(
                  height: 300,
                    width: MediaQuery.of(context).size.width,
           
                      padding: const EdgeInsets.symmetric(horizontal: 8.0),
                       decoration: BoxDecoration(image: DecorationImage(image: AssetImage(Images.itbanner3), fit: BoxFit.cover)),
                ...
                Get.find<LocalizationController>().locale!.languageCode== "en" ?   Container(
                  height: 130,
                                 width: MediaQuery.of(context).size.width,
                decoration: BoxDecoration(image: DecorationImage(image: AssetImage(Images.videoenglish), fit: BoxFit.cover)),
                ):   Container(
                  height: 130,
                    width: MediaQuery.of(context).size.width,
           
                      padding: const EdgeInsets.symmetric(horizontal: 8.0),
                       decoration: BoxDecoration(image: DecorationImage(image: AssetImage(Images.videoitalian), fit: BoxFit.cover)),
                          ...
                          children: ref
                              ...
                              .map((e) => Container(
                                    ...
                                    decoration: BoxDecoration(
                                       border: Border.all(color:     const Color(0xffA4A4A4).withOpacity(0.5)),
                                        color: ref
                                                    .watch(
                                                        sheduleCallProvider)
                                                    .daySelected ==

                          ...
                          Expanded(
                              ...
                              child: SingleChildScrollView(
                                child: Column(
                                   ...
                                   cartModel?.item?.isService==0 ?    GetBuilder<CartController>(
                                 ...
                                 SizedBox(
                                          width: 400,
                                          child: Row(children: [
                                       cartModel?.item?.isService==0 ?      Expanded(
                                                flex: 5,
                                                child: CustomButton(
                                                  buttonText: (Get.find<
                                                                  SplashController>()
                              ...
                              onPressed: ()async{
                                     await ref
                                          ...
                                          .getAllSlots(context, "${DateFormat(
                                                  'EEE dd MMM',
                                                ).format(DateTime.now())}", true, itemController.item?.storeId, itemController.item?.id, itemController.item);    
                              },
                              buttonText: 'schedule'.tr,color: Color(0xff093b06), )),
                        );
                      })),
                                            const SizedBox(
                                                width: Dimensions

...
import 'package:farmacie_stilo/view/base/custom_divider.dart';
...
import 'package:farmacie_stilo/view/screens/order/widget/address_details.dart';
...
class TrackDetailsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    double distance = 0;
    bool takeAway = track.orderType == 'Collect from Pharmacy';
                  ...
                  ? InkWell(
                      ...
                      child: Column(children: [
                        Icon(Icons.directions,
                            size: 25, color: Color(0xff1a3922)),
                        Text(
                          'direction'.tr,
                          style: robotoRegular.copyWith(

...
import 'package:farmacie_stilo/view/screens/home/theme1/theme1_home_screen.dart';
import 'package:farmacie_stilo/view/screens/home/web_home_screen.dart';
import 'package:farmacie_stilo/view/screens/home/widget/filter_view.dart';
import 'package:farmacie_stilo/view/screens/home/widget/popular_item_view.dart';
import 'package:farmacie_stilo/view/screens/home/widget/item_campaign_view.dart';
import 'package:farmacie_stilo/view/screens/home/widget/banner_view.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:farmacie_stilo/view/screens/home/widget/module_view.dart';
...
List banner=[Images.telemedicine];
  @override
  void initState() {
    super.initState();
      ...
      return Scaffold(
        ...
        body: /*isTaxiBooking ? const RiderHomeScreen() :*/ isParcel
            ...
            : Container(
              ...
              //       image: AssetImage(Images.telemedicine),
              //       fit: BoxFit.fill,
              ...
              //             decoration: BoxDecoration(
              //            image: DecorationImage(
              //              image: AssetImage(Images.consegna),
              //              fit: BoxFit.fill,
              //              filterQuality: FilterQuality.high
              //               // You can adjust the BoxFit as needed
              //            ),
              ...
              //    decoration: BoxDecoration(
              //   image: DecorationImage(
              //     image: AssetImage(Images.appuntamento),
              //     fit: BoxFit.fill,
              //     filterQuality: FilterQuality.high
              //      // You can adjust the BoxFit as needed
              //   ),
                                                    ...
                                                    return PaginatedListView(
                                                      ...
                                                      itemView: ItemsView(
                                                        ...
                                                        stores: storeController
                                                            ...
                                                            ? storeController
                                                                .storeModel!
                                                                .stores!.where((element) => element.isservice==0).toList()
                                                            : null,
                                                        padding:
                                                    ...
                                                    return PaginatedListView(
                                                      ...
                                                      itemView: ItemsView(
                                                        ...
                                                        stores: storeController
                                                            ...
                                                            ? storeController
                                                                .storeModel!
                                                                .stores!.where((element) => element.isservice==1).toList()
                                                            : null,
                                                        padding:
                                                            EdgeInsets.symmetric(
                                                          horizontal: ResponsiveHelper
        ...
        //   onPressed: () {
       //  Get.toNamed(DoctorAvailability.routeName);
        //     //Get. Add your action here
        //     print('Floating action button pressed!');
        //   },
        //   child: Image.asset(Images.camera),
        //   backgroundColor: Color(0xff093b06),

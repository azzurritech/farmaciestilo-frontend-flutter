    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: Get.find<AuthController>().isLoggedIn()
            ...
            notificationController.notificationList![index].data!.orderid,
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Row(children: [
                                                    ClipOval(
                                                      ...
                                                      fit: BoxFit.cover,
                                                      image:
                                                         'https://new-admin.farmaciestilo.com/storage/app/public/store/${notificationController.notificationList![index].logo}',
                                                    )),
                                                    const SizedBox(
                                                        width: Dimensions
                                                            .paddingSizeSmall),

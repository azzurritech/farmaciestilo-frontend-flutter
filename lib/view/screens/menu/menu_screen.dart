...
import 'package:farmacie_stilo/data/model/response/menu_model.dart';
...
import 'package:farmacie_stilo/view/screens/menu/widget/menu_button.dart';
  ...
  Widget build(BuildContext context) {
    ...
    _menuList = [
      ...
      MenuModel(
          ...
          route: RouteHelper.getotherHtmlRoute('privacy-policy')),
      MenuModel(
          icon: Images.aboutUs,
          title: 'about_us'.tr,
      ...
      MenuModel(
          ...
          // title: 'Scheduling',
          route: DoctorAvailability.routeName),
      //bookingtrack
      MenuModel(icon: Images.booking, title: 'Booking'.tr, route: ''),
      //tracking
      MenuModel(
        icon: Images.trackorder,
        title: 'Track'.tr,
        route: RouteHelper.track,
      ),
    ...
    return PointerInterceptor(
      child: Container(
         height: ResponsiveHelper.isWeb() ? 600 : 550,

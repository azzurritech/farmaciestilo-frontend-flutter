...
import 'package:farmacie_stilo/view/screens/checkout/widget/slot_widget.dart';
...
class CheckoutState extends State<Checkout> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _isLoggedIn
          ? GetPlatform.isMobile ? GetBuilder<LocationController>(builder: (locationController) {
  ...
  _isDigitalPaymentActive! ? 0 : _isCashOnDeliveryActive! ? 1 : 2,
  isUpdate: false,
);
...
Container(   padding: const EdgeInsets
  ...
  child: Column(
    children: [
      Row(children: [
        Text(" Codice Fiscale"  ,style:  robotoMedium),
      Checkbox(
      ...
      child: SizedBox(
        ...
        child: TextField(
          ...
          style: robotoRegular.copyWith(
            height: ResponsiveHelper.isMobile(context) ? null : 2,
          ),

          decoration: InputDecoration(
            hintText: 'add_your_codice_fiscale'.tr,
...
String paymentUrl = '${AppConstants.baseUrl}/payment-mobile?customer_id=${int.parse(Get.parameters['user']!)}&order_id=${int.parse(Get.parameters['id']!)}';
  ...
  Widget _orderPlaceButton(
    ...
    return Container(
      ...
      child: !orderController.isLoading
          ? Padding(
            padding: const EdgeInsets.symmetric(horizontal: 58.0, vertical: 6),
            child: CustomButton(
                        ...
                        // }
                          ...
                          if (widget.storeId == null) {
                           ...
                           if(GetPlatform.isMobile || ResponsiveHelper.isWeb()){
                            final codetext=_codecontroller.text.toString();
                              orderController.placeOrder(
                                ...
                                maxCodOrderAmount);
                                              ...
                                              'delivery' && ResponsiveHelper.isWeb()){
                                                  final codetext=_codecontroller.text.toString();
                                                 orderController.placeOrder(
                                PlaceOrderBody(
                                  code: codetext,
                                ...
                                maxCodOrderAmount); 
                                              ...
                                              'delivery' && orderController.paymentMethodIndex==1){
                                                  final codetext=_codecontroller.text.toString();
                                                 orderController.placeOrder(
                                PlaceOrderBody(
                                  code: codetext,
                ...
                if (await canLaunchUrlString("https://new.farmaciestilo.com")) {
                    await launchUrlString("https://new.farmaciestilo.com", mode: LaunchMode.externalApplication);
                }
                // url launcher
        ...
        return InkWell(
          ...
          child: Row(
            children: [
              ...
              Text(
              '${(value == 'take_away' || isFree!) ? 'free'.tr : (orderController.orderType == "delivery" && total != null && total! > 59.00) ? 0.00 : PriceConverter.convertPrice(charge)}'
, style: robotoMedium,
              ),
            ],
          ),
...
// import 'package:farmacie_stilo/view/base/custom_text_field.dart';
// import 'package:farmacie_stilo/view/base/footer_view.dart';
// import 'package:farmacie_stilo/view/base/image_picker_widget.dart';
// import 'package:farmacie_stilo/view/base/menu_drawer.dart';
// import 'package:farmacie_stilo/view/base/my_text_field.dart';
// import 'package:farmacie_stilo/view/base/not_logged_in_screen.dart';
// import 'package:farmacie_stilo/view/screens/address/widget/address_widget.dart';
// import 'package:farmacie_stilo/view/screens/cart/widget/delivery_option_button.dart';
// import 'package:farmacie_stilo/view/screens/checkout/widget/condition_check_box.dart';
// import 'package:farmacie_stilo/view/screens/checkout/widget/payment_button.dart';
// import 'package:farmacie_stilo/view/screens/checkout/widget/slot_widget.dart';
// import 'package:get/get.dart';
...
// import 'package:farmacie_stilo/view/screens/checkout/widget/tips_widget.dart';
// import 'package:farmacie_stilo/view/screens/home/home_screen.dart';
// import 'package:farmacie_stilo/view/screens/store/widget/camera_button_sheet.dart';
// import 'package:universal_html/html.dart' as html;
// import 'package:flutter/material.dart';
// import 'package:url_launcher/url_launcher.dart';
// import 'package:url_launcher/url_launcher_string.dart';
...
//                                                         )
//                                                       : Text(
//                                                           '(+) ${total > 59.00 ? "£ 0.00" : PriceConverter.convertPrice(deliveryCharge)}',
//                                                           style: robotoRegular,
//                                                           textDirection:
//                                                               TextDirection.ltr,
//                                                         ),
...
//               amount,
//               _isCashOnDeliveryActive));
// //               String cartData = jsonEncode(_cartList!.map((item) => {
// //   'image': item!.item!.image,
// //   'title': item!.price,
// //   'total_price': item!.discountAmount,
...
//                            }
//                            else if(orderController.orderType ==
//                                               'take_away' && ResponsiveHelper.isWeb()){
//                                                   final codetext=_codecontroller.text.toString();
//                                                  orderController.placeOrder(
//                                 PlaceOrderBody(
//                                   code: codetext,
...
//                else if(orderController.orderType ==
//                                               'take_away' && orderController.paymentMethodIndex==1){
//                                                   final codetext=_codecontroller.text.toString();
//                                                  orderController.placeOrder(
//                                 PlaceOrderBody(
//                                   code: codetext,

...
class AuthRepo {
  ...
  Future<String?> _saveDeviceToken() async {
    ...
    if (!GetPlatform.isWeb) {
      ...
      if (settings.authorizationStatus == AuthorizationStatus.authorized) {
        deviceToken = await FirebaseMessaging.instance.getToken(vapidKey: "BGS7y-HebmI0exeT9eiOC-S-VLfkDkgQDoBJheRmzD8wMDMozJFDReydI0prskdNbesovbo3zrdgThIu7wk_UyI");
      }
